...
function concat_map(f, param) {
  if (param) {
    return prepend_concat_map(Curry._1(f, param.hd), f, param.tl);
  } else {
    return /* [] */0;
  }
}

function prepend_concat_map(ys, f, xs) {
  if (ys) {
    return {
            hd: ys.hd,
            tl: prepend_concat_map(ys.tl, f, xs)
          };
  } else {
